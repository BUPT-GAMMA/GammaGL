...
if __name__ == '__main__':
    ...
    # path settings
    parser.add_argument("--train_filename", type=str, default='gan_datasets/' + dataset + '_train.txt',
                        help="train_filename")
    parser.add_argument("--pre_train_emb_filename_d", type=str,
                        default='gan_datasets/' + dataset + '_pre_train.emb',
                        help="pre_train_d_emb_filename")
    parser.add_argument("--pre_train_emb_filename_g", type=str,
                        default='gan_datasets/' + dataset + '_pre_train.emb',
                        help="pre_train_g_emb_filename")
    parser.add_argument("--test_filename", type=str, default='gan_datasets/' + dataset + '_test.txt',
                        help="test_filename")
    parser.add_argument("--test_neg_filename", type=str,
                        default='gan_datasets/' + dataset + '_test_neg.txt',
