...
def main(args):
    ...
    net = ChebNetModel(feature_dim=dataset.num_node_features,
                       hidden_dim=args.hidden_dim,
                       out_dim=graph.num_nodes,
                       k=args.k,
    ...
    for epoch in range(args.n_epoch):
        ...
        if val_acc > best_val_acc:
            ...
            net.save_weights(args.best_model_path + "ChebNet_" + args.dataset + ".npz", format='npz_dict')

    net.load_weights(args.best_model_path + "ChebNet_" + args.dataset + ".npz", format='npz_dict')
