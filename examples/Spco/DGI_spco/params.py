...
def blog_params():
    ...
    parser.add_argument('--lambd', type=float, default=1e-3)
    parser.add_argument('--der-1', type=float, default=0.5)
    parser.add_argument('--dfr-1', type=float, default=0.3)
    parser.add_argument('--der-2', type=float, default=0.5)
    parser.add_argument('--dfr-2', type=float, default=0.3)
    parser.add_argument('--hid_dim', type=int, default=512)
    parser.add_argument('--seed', type=int, default=2)
