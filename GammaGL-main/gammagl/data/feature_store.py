...
class FeatureStore(ABC):
    ...
    @abstractmethod
    def _get_tensor(slef, attr: TensorAttr) -> Optional[FeatureTensorType]:
        r"""To be implemented by :class:`FeatureStore` subclasses."""
        pass
    ...
    def _to_type(
        ...
        if tlx.is_tensor(attr) and isinstance(tensor, np.ndarray):
    ...
    def __setitem__(self, key: TensorAttr, value: FeatureTensorType):
        ...
        # CastMixin will handle the case of key being a tuple or TensorAttr object:
