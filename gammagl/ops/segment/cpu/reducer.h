...
struct Reducer {
  ...
  Reducer(ReductionType REDUCE) { this->REDUCE = REDUCE; }
  ...
  void update(Tp *val, Tp new_val, Tp *arg, Tp new_arg) {
  ...
  void write(Tp *address, Tp val, Tp *arg_address, Tp arg, int count) {
