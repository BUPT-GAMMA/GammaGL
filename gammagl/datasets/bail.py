...
class Bail(InMemoryDataset):
    ...
    Nodes represent defendants released on bail.
    ...
    def __init__(self, root=None, transform=None, pre_transform=None, pre_filter=None, force_reload: bool = False):
        self.name = 'bail'
        self.top_k = 10
        self.strlist = ['_B0', '_B1','_B2', '_B3', '_B4']
        super(Bail, self).__init__(root, transform, pre_transform, pre_filter, force_reload = force_reload)
