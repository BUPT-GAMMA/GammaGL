...
class CompGCN(tlx.nn.Module):
    ...
    def __init__(self, feature_dim, hidden_dim, num_class,op, num_relations,num_entity, name=None):
        ...
        self.relu = tlx.ReLU()
        self.init_input = tlx.ops.xavier_normal((num_entity, feature_dim), dtype=tlx.float32)
        self.ref_input = tlx.ops.xavier_normal((num_relations + 1, 32), dtype=tlx.float32)
